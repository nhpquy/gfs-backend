...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        LoggerUtil.d(this, "Config cross origin: " + String.join(",", ApplicationProperties.getAllowedCrossDomainsAdmin()));
        registry.addMapping("/**")
                .allowedOrigins(ApplicationProperties.getAllowedCrossDomainsAdmin()
