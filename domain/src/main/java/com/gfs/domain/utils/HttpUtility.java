...
import com.gfs.domain.model.HttpRes;
...
public class HttpUtility {
     ...
     */
    public static HttpRes sendPostWithAuthorizeData(String url, String data, String authorizeData) throws Exception {
        String result = "";
    ...
    public static HttpRes sendPostFormUrlEncoded(String url, List<Header> headers, Map<String, String> fields) throws Exception {
        String result = "";
        int responseCode = 200;
        HttpPost post = new HttpPost(url);
        try {
            ...
            for (String key : fields.keySet())
                nameValuePairs.add(new BasicNameValuePair(key, fields.get(key)));
